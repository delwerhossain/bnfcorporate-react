...
const NavCon = () => {
  ...
  return (
    <>
      ...
      <div className="md:fixed relative top-0 z-10 w-full bg-white mb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center border-b-2 border-gray-100 py-1 md:justify-start md:space-x-10">
            ...
            <nav className="hidden md:flex space-x-10">
              ...
              <Link
                to={"contact"}
                className="text-base bg-orange-600 p-0.5 rounded-3xl  px-2 font-medium text-white hover:text-gray-900"
              >
                Contact
              </Link>
